...
To install the projects, it is necessary to verify the following prerequisites: Have Node.js and npm installed. You can install [Download and install Node.js](https://nodejs.org/en)
